...
public class SimpleHttpClientImpl implements HttpClient {
    ...
    private final int CONNECT_TIMEOUT = Integer.valueOf(Config.getConfigProperty("connection.connect.timeout"));
    private final int READ_TIMEOUT = Integer.valueOf(Config.getConfigProperty("connection.read.timeout"));
